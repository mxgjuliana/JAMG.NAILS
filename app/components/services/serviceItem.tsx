...
interface ServiceItemProps {
  servicio: IService;
  isSelected: boolean;
  onSelect: (servicio: IService) => void;
}

const ServiceItem: React.FC<ServiceItemProps> = ({ servicio, isSelected, onSelect }) => {
    ...
    >
      <View style={styles.serviceInfo}>
        ...
        <View style={styles.serviceDetails}>
          <Text style={styles.serviceDuration}>Aprox. {servicio.Duracion} min</Text>
        </View>
      </View>
      <MaterialIcons
